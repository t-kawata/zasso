...
.PHONY: install-context-mode update-context-mode stubs crimes archive-tickets
...
# キュー・specs・context を tickets/archive/ に退避して空にする
archive-tickets:
	@bash .claude/scripts/tickets/archive-tickets.sh
