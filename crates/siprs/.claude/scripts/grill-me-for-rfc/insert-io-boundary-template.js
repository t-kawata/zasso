 ...
 *
 * RFC ファイルに「split-rfc-to-children のための参考情報 — RFC設計書が示す I/O 境界の手がかり」
 * セクションをテンプレートとして追記する。
 *
...
const sectionPattern = /split-rfc-to-children\s*のための参考情報/;
...
const template = `\n\n## ${sn}. split-rfc-to-children のための参考情報 — RFC設計書が示す I/O 境界の手がかり
