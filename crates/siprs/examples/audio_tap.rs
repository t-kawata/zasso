...
// [::STUB::] P1-3: example documents the audio-tap surface (P8-2 O-007); full CLI/PJSIP runtime still deferred -- Implement full audio tap example with PJSIP backend, CLI args, and integration test
