...
//
// [::STUB::] P0-7: Full SIP account management implementation (N0025, N0026).
...
// to P0-7 (Public API Surface & Account/Transport Configuration) when
// the FFI layer (P0-6) is available to drive pjsua_acc_* APIs.
...
///
/// [::STUB::] P0-7: Replace `pub` fields with proper `get_*` accessors
