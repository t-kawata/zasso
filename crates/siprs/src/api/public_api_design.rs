...
//
// Mapped node(s):
//   - NODE_ID=N0015:  §8 Public API Design
...
//   - rationale/§41 Usage Examples [NODE_ID=N0070]
//     (references → src/api/public_api_design.rs)
//     → (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --dirs-tree="RFC-ROOT-Dirs-Tree.json" --id=N0070 --hops=2)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0015: §8 Public API Design
