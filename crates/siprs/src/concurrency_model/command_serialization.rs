...
//
// Mapped node(s):
//   - NODE_ID=N0011:  §7.2 command serialization
//     → To show details: (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --id=N0011)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0011: §7.2 command serialization
