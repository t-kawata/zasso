...
//
// Mapped node(s):
//   - NODE_ID=N0071:  §40 audio device policy
//     → To show details: (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --id=N0071)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0071: §40 audio device policy
