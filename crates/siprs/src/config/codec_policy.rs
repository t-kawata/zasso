...
//
// Mapped node(s):
//   - NODE_ID=N0058:  §29 codec policy 強制
//     → To show details: (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --id=N0058)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0058: §29 codec policy 強制
