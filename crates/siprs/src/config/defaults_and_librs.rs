...
//
// Mapped node(s):
//   - NODE_ID=N0084:  §48 デフォルトポリシーと lib.rs
//     → To show details: (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --id=N0084)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0084: §48 デフォルトポリシーと lib.rs
