...
//
// Mapped node(s):
//   - NODE_ID=N0060:  §30 SRTP 仕様
//     → To show details: (cd ../.. && node .claude/scripts/rfc-graph/query.js --graph="RFC-ROOT-GRAPH.json" --source="RFC-ROOT.md" --id=N0060)
//
...
// TODO: [::STUB::] MUST implement NODE_ID=N0060: §30 SRTP 仕様
