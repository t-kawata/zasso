...
// [::TICKET::] P3-2, P7-2, P8-1, P10-1, P11-6, P11-10, P11-11 changes. Details: `node .claude/scripts/tickets/show-ticket-context.js --ticket-key=(P3-2|P7-2|P8-1|P10-1|P11-6|P11-10|P11-11) --for-spec --no-implementation-order`.
