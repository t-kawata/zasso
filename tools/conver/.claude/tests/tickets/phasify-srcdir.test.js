...
(function testC004Step9NoSrcDirOption() {
  const md = fs.readFileSync(path.resolve('.claude/commands/find-omissions.md'), 'utf8');
...
(function testC005TestsNoSrcDirReference() {
  const t1 = fs.readFileSync(path.resolve('.claude/scripts/rfc-graph/phasify-omissions.test.js'), 'utf8');
  const t2 = fs.readFileSync(path.resolve('.claude/scripts/tickets/tests/phasify-key-rewrite.test.js'), 'utf8');
