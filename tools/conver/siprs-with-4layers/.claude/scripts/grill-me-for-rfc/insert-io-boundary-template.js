...
// The literal "+" in the real heading must be escaped; the archived regex
// treated it as a quantifier and failed to match the actual heading.
const sectionPattern = /graphify-rfc \+ boundify-graph のための参考情報/;
if (sectionPattern.test(content)) {
  process.stdout.write("I/O boundary reference section already exists. Skipping.\n");
  process.exit(0);
}
